...
public class PesananDiprosesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvPesananSaya = rootView.findViewById(R.id.recycler_penghasilan_saya);
        loadData();
    ...
    private void loadData() {
        ...
        PenghasilanSayaAdapter adapter = new PenghasilanSayaAdapter(listPenghasilan, getActivity());
        rvPesananSaya.setHasFixedSize(true);
        rvPesananSaya.setLayoutManager(new LinearLayoutManager(getActivity()));
        rvPesananSaya.setAdapter(adapter);
